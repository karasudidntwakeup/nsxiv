...
static const char *WIN_BG[]   = { "Nsxiv.window.background",   "#141423" };
static const char *WIN_FG[]   = { "Nsxiv.window.foreground",   "#ffffff" };
...
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "Comic Code:size=8" };
